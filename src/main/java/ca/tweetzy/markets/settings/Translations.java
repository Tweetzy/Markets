...
public final class Translations extends TranslationManager {
	...
	public static TranslationEntry PLACE_ITEM_FIRST = create("error.place sell item", "&cPlease provide an item to sell first!");
	...
	public static TranslationEntry PLAYERS_LOOKING_AT_ITEM = create("error.item being viewed", "&cCustomer(s) are currently viewing that item.");
