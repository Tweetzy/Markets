...
public class _1_InitialMigration extends DataMigration {
    ...
    public void migrate(Connection connection, String tablePrefix) throws SQLException {
        ...
        try (Statement statement = connection.createStatement()) {
            ...
            statement.execute("CREATE TABLE " + tablePrefix + "blocked_items (" +
                    "id INTEGER PRIMARY KEY" + autoIncrement + ", " +
                    "blocked_id VARCHAR(36) NOT NULL, " +
                    "item TEXT NOT NULL )");

            statement.execute("CREATE TABLE " + tablePrefix + "bank (" +
                    "id INTEGER PRIMARY KEY" + autoIncrement + ", " +
            ...
            statement.execute("CREATE TABLE " + tablePrefix + "transactions (" +
                    ...
                    "market_id VARCHAR(36) NOT NULL, " +
                    "purchaser VARCHAR(36) NOT NULL, " +
                    "item TEXT NOT NULL, " +
                    "quantity INTEGER NOT NULL, " +
                    "price DOUBLE NOT NULL, " +
                    "time BigInt NOT NULL )");

            statement.execute("CREATE TABLE " + tablePrefix + "upkeep (" +
                    "id INTEGER PRIMARY KEY" + autoIncrement + ", " +
