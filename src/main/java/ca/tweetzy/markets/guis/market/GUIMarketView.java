...
public class GUIMarketView extends Gui {
    ...
    private void draw() {
        ...
        setButton(5, 4, ConfigItemUtil.build(Common.getItemStack(Settings.GUI_CLOSE_BTN_ITEM.getString()), Settings.GUI_CLOSE_BTN_NAME.getString(), Settings.GUI_CLOSE_BTN_LORE.getStringList(), 1, null), ClickType.LEFT, e -> e.manager.showGUI(e.player, new GUIMarketList()));
        ...
        setButton(2, 2, ConfigItemUtil.build(Common.getItemStack(Settings.GUI_MARKET_VIEW_ITEMS_ALL_ITEMS_ITEM.getString()), Settings.GUI_MARKET_VIEW_ITEMS_ALL_ITEMS_NAME.getString(), Settings.GUI_MARKET_VIEW_ITEMS_ALL_ITEMS_LORE.getStringList(), 1, null), ClickType.LEFT, e -> {
