...
//            this.requestedItems = Markets.getInstance().getRequestManager().getPlayerRequests(this.player, true).stream().filter(Request::isFulfilled).collect(Collectors.toList());
